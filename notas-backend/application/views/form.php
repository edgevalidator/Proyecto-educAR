...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<form id="new_nota_form" class="appnitro"  method="post" action="http://localhost/notas-backend/index.php/nota/nuevaNota">
			...
			<h2>Nueva nota</h2>
				...
				<ul >
					<li id="li_1" >
						...
						<div>
							<textarea id="texto_nota" name="texto_nota" class="element textarea medium"></textarea> 
						</div> 
					</li>		
					<li id="li_2" >
